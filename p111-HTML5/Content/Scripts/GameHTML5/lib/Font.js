...
(function(window){
  ...
  Font.prototype.validate = function (target, zero, mark, font, timeout) {
    ...
    /*console.log(target);
    console.log(getComputedStyle(target, null));
    console.log(getComputedStyle(target, null).getPropertyValue("width"));*/
  ...
  Font.prototype.bootstrapValidation = function (printChar, timeout) {
    ...
    para.style.cssText = "top: 0; left: 0; opacity: 0;";
  ...
  Font.prototype.toStyleNode = function () {
    ...
    var fixedIEUrl = this.url.replace('.ttf', '.woff');
    var styletext = "@font-face {\n";
       ...
       if (IEversion !== false) {
         styletext += "  src: url('" + fixedIEUrl + "') format('woff'), url('" + this.url + "') format('" + this.format + "');\n";
       } else {
